...
male_graf = go.Pie(labels=xm, values=ym, name='male')
female_graf = go.Pie(labels=xf, values=yf, name='female')
#combine
fig = tools.make_subplots(rows=1, cols=3)
fig.add_pie(male_graf, 1, 1)
fig.add_pie(female_graf, 1, 2)
fig.add_bar(first_graf, 1, 3)
pl.plot(fig)